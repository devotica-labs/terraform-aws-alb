...
<!-- List any removed/renamed variables/outputs.
     ...
     Any change to a security-relevant default (enable_deletion_protection,
     drop_invalid_header_fields, desync_mitigation_mode, default ssl_policy)
     is a consumer-facing breaking change — flag it here. -->
